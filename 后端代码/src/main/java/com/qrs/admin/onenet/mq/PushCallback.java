...
public class PushCallback implements MqttCallback {
    ...
    public PushCallback(MqClient client, MessageHandler messageHandler) {
        mqClient = client;
    ...
    public void messageArrived(String topic, MqttMessage message)  {
       try {
           ...
           JSONObject appProperty = jsonObject.getJSONObject("appProperty");
           String body2 = jsonObject.getString("body");
           handler.handle(msgid, body2);
