package com.qrs.admin.onenet.mq;
...
public class MqClient {
    ...
    public MqClient(MessageHandler messageHandler) {
    ...
    public synchronized boolean connect(){
        ...
        String userName = "qrs1"; //MQID

        String mqTopic = "qrs1"; //mq topic
        String mqSub = "qrs1"; // mq sub
    ...
    private void resetOptions(){
        String userName = "qrs1"; //MQID
        String accessKey = "iKD6WT0YbFWvFF3eVjON4o6UGOA+vau36+bRJdNmQKU="; //mq access_key
